# python -m unittest -v test_dissipation11e.py
# python -m unittest -v tests/test_dissipation11e.py 

# Author: John A. Marohn (jam99@cornell.edu)
# Date: 2025-08-28   
# Summary: Test the KmatrixIII_jit and KmatrixIV_jit functions in dissipation11e.py.
...
from dissipationtheory.dissipation11e import KmatrixIII_jit, KmatrixIV_jit
    ...
    def test_Sample3(self):
        ...
        for idx1, omega in enumerate(self.omega_array):
            ...
            for idx2, (loc1_nm, loc2_nm) in enumerate(zip(self.loc1_nm_array, self.loc2_nm_array)):
                ...
                results[idx1, idx2, 0] = np.allclose(b.real, a.real, atol=0., rtol=0.5e-2) 
                results[idx1, idx2, 1] = np.allclose(b.imag, a.imag, atol=0., rtol=0.5e-2)
